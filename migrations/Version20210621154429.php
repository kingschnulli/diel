 ...
 */
final class Version20210621154429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, quota, name FROM user');
        ...
        $this->addSql('INSERT INTO user (id, email, roles, password, quota, name) SELECT id, email, roles, password, quota, name FROM __temp__user');
