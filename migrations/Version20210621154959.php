 ...
 */
final class Version20210621154959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_group (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, longdescription CLOB DEFAULT NULL)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, name, startdate, enddate, quota, description, longdescription FROM event');
        ...
        $this->addSql('INSERT INTO event (id, name, startdate, enddate, quota, description, longdescription) SELECT id, name, startdate, enddate, quota, description, longdescription FROM __temp__event');
